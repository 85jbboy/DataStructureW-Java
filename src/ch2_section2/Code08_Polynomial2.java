...
public class Code08_Polynomial2 {
	public char name;          // 다항식 이름
	public Code08_Term2[] terms;       // 각 항의 차수와 지수를 저장하는 Term 배열
	public int nTerms;         // 항의 총 개수
	
	public Code08_Polynomial2(char name) {
		this.name = name;
		nTerms = 0;
		terms = new Code08_Term2[100];	
	}
	...
	public void addTerm(int coef, int expo) {
		...
		if(index != -1) {                // 같은 지수가 이미 존재하면 그냥 차수끼리 더해주면 됨.
			...
			terms[i+1] = new Code08_Term2(coef, expo);
			nTerms++;
		}	
	}
